...
```json
{
  ...
  "title_system": {
    ...
    "cover": "May use a centered ceremonial title with restrained gold dividers and a larger scale.",
    "section_divider": "May use a short centered or left-aligned section title with more negative space and a distinct section marker.",
    "content_slide": "Prefer a stable top title area with the same alignment, visual weight, and distance from the content region across the deck.",

...
```json
{
  ...
  "title_system": {
    ...
    "content_slide": "Prefer a restrained top section-navigation cue, a prominent centered main title, and a small gold separator. Keep this hierarchy recognizable across content slides while adapting its exact form, scale, and spacing to the page content.",

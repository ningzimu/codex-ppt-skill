...
```json
{
  ...
  "color_palette": {
    ...
    "accent": "restrained matte gold #D6A84B and warm amber #E9A11B for numbers, icons, connectors, and small title ornaments",
  ...
  "title_system": {
    ...
    "content_slide": "Prefer an optional restrained section-navigation cue, a prominent centered main title, and a small gold separator. Do not invent section numbers; include a number only when it is defined by the approved outline. Keep the hierarchy recognizable across content slides while adapting its exact form, scale, and spacing to the page content.",

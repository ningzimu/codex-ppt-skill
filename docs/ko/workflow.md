...
agent가 2~3가지 스타일 방향을 제안하고 하나를 추천합니다. 후보 스타일은 13가지 내장 스타일(깔끔한 전문 스타일, 연구 발표 스타일, 손그림 기술 설명 스타일, McKinsey 스타일, 당·정 홍보용 레드 스타일, 교육용 코스웨어 스타일, 중국전자클라우드 스타일 등)과 개인 스타일 라이브러리에서 가져옵니다. 사용자가 제공한 스크린샷, PDF 또는 PPT를 바탕으로 스타일을 재현할 수도 있습니다. 전체 스타일 미리보기는 [스타일 및 개인 스타일 라이브러리](/ko/styles.md)를 참고하세요.
